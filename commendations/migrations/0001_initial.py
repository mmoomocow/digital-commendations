    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commendation_type', models.CharField(choices=[('R', 'Respect'), ('I', 'Integrity'), ('S', 'Service'), ('E', 'Excellence'), ('O', 'Other')], max_length=1, verbose_name='Commendation Type')),
                ...
                ('students', models.ManyToManyField(to='students.student', verbose_name='Students')),
